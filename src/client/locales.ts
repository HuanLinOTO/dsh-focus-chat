...
export const zh = {
  ...
  'turnError': '本轮运行失败',
  'systemPrompt': '系统提示词',
  'turnMaxTokens': '已达到输出 token 上限',
  'turnMaxTokens.hint': '回答被截断，已有输出保留在对话中。发送“继续”可让模型接着输出。',
  'loadingHistory': '载入历史…',
...
export const en = {
  ...
  'turnMaxTokens': 'Output token limit reached',
  'turnMaxTokens.hint': 'The reply was cut off; earlier output is preserved in the conversation. Send “continue” to let the model resume.',
