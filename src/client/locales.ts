...
export const zh = {
  ...
  'terminal.noExitCode': '无退出码',
  'terminal.codeLabel': '代码',
  'terminal.wrapLabel': '自动换行',
  'terminal.unwrapLabel': '不换行',
  ...
  'turnUsage.summaryWithCache': '{total} · 缓存命中率 {percent}%',
...
export const en = {
  ...
  'terminal.codeLabel': 'Code',
  'terminal.wrapLabel': 'Wrap lines',
  'terminal.unwrapLabel': 'No wrap',
